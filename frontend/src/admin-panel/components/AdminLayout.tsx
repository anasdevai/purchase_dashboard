...
export function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 text-slate-700 lg:flex-row">
      {/* Sidebar */}
      <aside className="z-30 flex w-full shrink-0 flex-col bg-sidebar text-white shadow-md lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:w-64">
        {/* Logo / Title */}
      ...
      {/* Main content */}
      <main className="min-h-screen flex-1 bg-slate-50 p-0 text-slate-700 lg:ml-64">
        <Outlet />
      </main>
    </div>
  )
